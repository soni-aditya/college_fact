    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col s3 offset-s1 grey lighten-3 make_post">
                <h5 class="center">Create an Event !</h5>
                <div class="divider"></div>
                {!! Form::open(['url'=>'create-event',   'method'=>'post' ,'files'=>true]) !!}
                <div class="row">
                ...
                <div class="row left">
                    <div class="col input-field col s11 offset-s9">
                        <button class="btn waves-effect waves-light purple right" type="submit" name="action" id="send">
                            SHARE POST
                        </button>
                    </div>
                </div>
